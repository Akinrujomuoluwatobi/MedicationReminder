package com.royalteck.progtobi.medicationreminder.data;
...
public class AlarmReminderProvider extends ContentProvider {
    ...
    public Cursor getMedicationBySearch(String search){
        ...
        String selectQuery = "SELECT _id as "+
                ...
                AlarmReminderContract.AlarmReminderEntry.KEY_ACTIVE + " FROM " + AlarmReminderContract.AlarmReminderEntry.TABLE_NAME +
                " WHERE " + AlarmReminderContract.AlarmReminderEntry.KEY_TITLE + " LIKE  '%" + search + "%' ";
